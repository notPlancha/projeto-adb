mongoexport --db=atp --collection=backhands --type=csv --fields=_id --out=.\data\exports\backhand.csv
mongoexport --db=atp --collection=domHands --type=csv --fields=_id --out=.\data\exports\domhand.csv
